...
!(function (t, e) {
	...
	return (() => {
		...
		var o, s, n, a, r, l, c, d, h, u, v, p, y, m, f, g, b, w, x, k;
		!(function (t) {
			(t.bottom = "bottom"),
				(t.left = "left"),
				(t.right = "right"),
		...
		class M {
			...
			add(t) {
				return M.create(this.x + t.x, this.y + t.y);
			}
			addTo(t) {
			...
			mult(t) {
				return M.create(this.x * t, this.y * t);
			}
			multTo(t) {
				(this.x *= t), (this.y *= t);
			}
		...
		class P {
			...
			static randomInRange(t) {
				const e = P.getRangeMax(t);
				let i = P.getRangeMin(t);
				return e === i && (i = 0), Math.random() * (e - i) + i;
			}
			static getRangeValue(t) {
				return "number" == typeof t ? t : P.randomInRange(t);
			}
			...
			static getValue(t) {
				...
				return i
					? P.getRangeValue(P.setRangeValue(t.value, o))
					: P.getRangeValue(t.value);
			}
			...
			static getDistance(t, e) {
				return P.getDistances(t, e).distance;
			}
		...
		class z {
			...
			static itemFromArray(t, e, i = !0) {
				return t[void 0 !== e && i ? e % t.length : z.arrayRandomIndex(t)];
			}
			static isPointInside(t, e, i, o) {
				return z.areBoundsInside(z.calculateBounds(t, null != i ? i : 0), e, o);
			}
			static areBoundsInside(t, e, i) {
				let s = !0;
				return (
					(i && i !== o.bottom) || (s = t.top < e.height),
					!s || (i && i !== o.left) || (s = t.right > 0),
					!s || (i && i !== o.right) || (s = t.left < e.width),
					!s || (i && i !== o.top) || (s = t.bottom > 0),
					s
				);
			}
			...
			static downloadSvgImage(t) {
				return R(this, void 0, void 0, function* () {
					...
					if ("svg" !== e.type) return z.loadImage(t);
			...
			static isDivModeEnabled(t, e) {
				return e instanceof Array
					? !!e.find((e) => e.enable && z.isInArray(t, e.mode))
					: z.isInArray(t, e.mode);
			}
			static divModeExecute(t, e, i) {
				if (e instanceof Array)
					for (const o of e) {
						const e = o.mode;
						o.enable && z.isInArray(t, e) && z.singleDivModeExecute(o, i);
					}
				else {
					const o = e.mode;
					e.enable && z.isInArray(t, o) && z.singleDivModeExecute(e, i);
				}
			}
			...
			static circleBounceDataFromParticle(t) {
				return {
					...
					velocity: t.velocity,
					factor: {
						horizontal: P.getValue(t.options.bounce.horizontal),
						vertical: P.getValue(t.options.bounce.vertical),
					},
				};
			}
			static circleBounce(t, e) {
				...
				if (i * (n.x - s.x) + o * (n.y - s.y) >= 0) {
					const i = -Math.atan2(n.y - s.y, n.x - s.x),
						...
						c = P.collisionVelocity(r, l, o, a),
						d = P.collisionVelocity(l, r, o, a),
						h = c.rotate(-i),
						u = d.rotate(-i);
			...
			static rectBounce(t, e) {
				const i = t.getPosition(),
					...
					n = S(
						...
						t.velocity.x,
						P.getValue(t.options.bounce.horizontal)
					);
				n.bounced &&
				...
				const a = S(
					...
					{ min: e.left, max: e.right },
					t.velocity.y,
					P.getValue(t.options.bounce.vertical)
				);
				a.bounced &&
					(void 0 !== a.velocity && (t.velocity.y = a.velocity),
		...
		(A.canvasClass = "tsparticles-canvas-el"),
			(A.randomColorValue = "random"),
			(A.midColorValue = "mid"),
			(A.touchEndEvent = "touchend"),
			(A.mouseDownEvent = "mousedown"),
			(A.mouseUpEvent = "mouseup"),
			(A.mouseMoveEvent = "mousemove"),
			(A.touchStartEvent = "touchstart"),
			(A.touchMoveEvent = "touchmove"),
			(A.mouseLeaveEvent = "mouseleave"),
			(A.mouseOutEvent = "mouseout"),
			(A.touchCancelEvent = "touchcancel"),
			(A.resizeEvent = "resize"),
			(A.visibilityChangeEvent = "visibilitychange"),
			(A.noPolygonDataLoaded = "No polygon data loaded."),
			(A.noPolygonFound =
		...
		class D {
			...
			static colorToHsl(t, e, i = !0) {
				const o = D.colorToRgb(t, e, i);
				return void 0 !== o ? D.rgbToHsl(o) : void 0;
			}
			static rgbToHsl(t) {
				const e = t.r / 255,
					i = t.g / 255,
			...
			static stringToAlpha(t) {
				var e;
				return null === (e = O(t)) || void 0 === e ? void 0 : e.a;
			}
			...
			static rgbaToHsva(t) {
				const e = D.rgbToHsv(t);
				return { a: t.a, h: e.h, s: e.s, v: e.v };
			}
			static getRandomRgbColor(t) {
				const e = null != t ? t : 0;
				return {
					b: Math.floor(P.randomInRange(P.setRangeValue(e, 256))),
					g: Math.floor(P.randomInRange(P.setRangeValue(e, 256))),
					r: Math.floor(P.randomInRange(P.setRangeValue(e, 256))),
				};
			}
			...
			static getStyleFromHsv(t, e) {
				return D.getStyleFromHsl(D.hsvToHsl(t), e);
			}
			static mix(t, e, i, o) {
				let s = t,
					n = e;
			...
			static replaceColorSvg(t, e, i) {
				...
				if (o.includes("fill")) {
					...
					return o.replace(t, () => D.getStyleFromHsl(e, i));
				}
				const s = o.indexOf(">");
				return `${o.substring(0, s)} fill="${D.getStyleFromHsl(
					e,
					i
				)}"${o.substring(s)}`;
			}
				...
				if ("mid" !== i) return i;
				{
					const i =
							null !== (o = t.getFillColor()) && void 0 !== o
								...
								: t.getStrokeColor(),
						n =
							null !== (s = null == e ? void 0 : e.getFillColor()) &&
							void 0 !== s
								? s
								: null == e
								? void 0
								: e.getStrokeColor();
					if (i && n && e) return D.mix(i, n, t.getRadius(), e.getRadius());
					{
						const t = null != i ? i : n;
		...
		class I {
			...
			static drawLinkLine(t, e, i, o, s, n, a, r, l, c, d, h) {
				let u = !1;
				if (P.getDistance(i, o) <= s) E(t, i, o), (u = !0);
				else if (a) {
					let e, a;
				...
				if (u) {
					if (
						...
						e &&
							((t.shadowBlur = h.blur), (t.shadowColor = D.getStyleFromRgb(e)));
					}
					t.stroke();
				}
			}
			static drawLinkTriangle(t, e, i, o, s, n, a, r) {
				!(function (t, e, i, o) {
					...
					(t.fillStyle = D.getStyleFromRgb(a, r)),
					t.fill();
			}
			...
			static drawParticleShadow(t, e, i, o) {
				...
				const h = [],
					u = n.length;
				for (const t of d) {
					const e = Math.atan2(o.y - t.y, o.x - t.x),
						i = t.x + u * Math.sin(-e - Math.PI / 2),
						s = t.y + u * Math.cos(-e - Math.PI / 2);
					h.push({ endX: i, endY: s, startX: t.x, startY: t.y });
				}
			...
			static drawParticle(t, e, i, o, s, n, a, r, l, c, d) {
				...
				e.save(),
					u.enable || v.enable
						? e.setTransform(
								v.enable ? Math.cos(i.rollAngle) : 1,
								u.enable ? Math.cos(i.tilt.value) * i.tilt.cosDirection : 0,
								u.enable ? Math.sin(i.tilt.value) * i.tilt.sinDirection : 0,
								v.enable ? Math.sin(i.rollAngle) : 1,
								h.x,
								h.y
						  )
						: e.translate(h.x, h.y),
				...
				d.enable &&
					y &&
					((e.shadowBlur = d.blur),
					(e.shadowColor = D.getStyleFromRgb(y)),
				...
				(e.lineWidth = i.strokeWidth),
					...
					I.drawShapeAfterEffect(t, e, i, l, c, o),
					e.restore();
			}
		...
		class L extends F {
			...
			intersects(t) {
				...
				if (void 0 !== i.radius) {
					const t = new F(o.x, o.y, 2 * i.radius);
					return super.intersects(t);
				}
				if (void 0 !== e.size) {
					const t = new H(o.x, o.y, 2 * e.size.width, 2 * e.size.height);
					return super.intersects(t);
				}
				return !1;
			}
		...
		class _ {
			...
			manageListeners(t) {
				...
				if (s === k.window)
					(i.interactivity.element = window), (n = A.mouseOutEvent);
				else if (s === k.parent && i.canvas.element) {
				...
				(o.interactivity.events.onHover.enable ||
					...
					(q(a, A.mouseMoveEvent, this.mouseMoveHandler, t),
					q(a, A.touchStartEvent, this.touchStartHandler, t),
					q(a, A.touchMoveEvent, this.touchMoveHandler, t),
					o.interactivity.events.onClick.enable
						? (q(a, A.touchEndEvent, this.touchEndClickHandler, t),
						  q(a, A.mouseUpEvent, this.mouseUpHandler, t),
						  q(a, A.mouseDownEvent, this.mouseDownHandler, t))
						: q(a, A.touchEndEvent, this.touchEndHandler, t),
					q(a, n, this.mouseLeaveHandler, t),
					q(a, A.touchCancelEvent, this.touchCancelHandler, t)),
					i.canvas.element &&
						(i.canvas.element.style.pointerEvents =
							r === i.canvas.element ? "initial" : "none"),
					o.interactivity.events.resize &&
						q(window, A.resizeEvent, this.resizeHandler, t),
					document &&
						q(
							document,
			...
			mouseTouchMove(t) {
				...
				d && ((d.x *= u), (d.y *= u)),
					...
					(l.interactivity.status = A.mouseMoveEvent);
			}
			mouseTouchFinish() {
				const t = this.container.interactivity;
				if (void 0 === t) return;
		...
		class $ {
			static getPlugin(t) {
				return B.find((e) => e.id === t);
			}
			static addPlugin(t) {
				$.getPlugin(t.id) || B.push(t);
			}
			...
			static loadOptions(t, e) {
				for (const i of B) i.loadOptions(t, e);
			}
			static getPreset(t) {
				return W.get(t);
			}
			static addPreset(t, e, i = !1) {
				(!i && $.getPreset(t)) || W.set(t, e);
			}
			static addShapeDrawer(t, e) {
				$.getShapeDrawer(t) || G.set(t, e);
			}
		...
		class j {
			...
			subdivide() {
				const t = this.rectangle.position.x,
					...
					s = this.capacity;
				(this.northEast = new j(new H(t, e, i / 2, o / 2), s)),
					(this.northWest = new j(new H(t + i / 2, e, i / 2, o / 2), s)),
					(this.southEast = new j(new H(t, e + o / 2, i / 2, o / 2), s)),
					(this.southWest = new j(
						new H(t + i / 2, e + o / 2, i / 2, o / 2),
						s
					)),
					(this.divided = !0);
			}
			...
			queryCircle(t, e) {
				return this.query(new F(t.x, t.y, e));
			}
			queryCircleWarp(t, e, i) {
				const o = i,
					s = i;
				return this.query(
					new L(t.x, t.y, e, void 0 !== o.canvas ? o.canvas.size : s)
				);
			}
			queryRectangle(t, e) {
				return this.query(new H(t.x, t.y, e.width, e.height));
			}
			query(t, e) {
				var i, o, s, n;
				const a = null != e ? e : [];
				...
				for (const e of this.points)
					t.contains(e.position) && a.push(e.particle);
				return (
					this.divided &&
		...
		class Y {
			...
			init(t) {
				...
				return X(this, void 0, void 0, function* () {
					...
					if (
						z.isInArray(g.char, i.particles.shape.type) ||
						z.isInArray(g.character, i.particles.shape.type)
					) {
						const t =
							null !== (e = i.particles.shape.options[g.character]) &&
							void 0 !== e
								? e
								: i.particles.shape.options[g.char];
						if (t instanceof Array) for (const e of t) yield z.loadFont(e);
			...
			draw(t, e, i, o) {
				...
				void 0 === a.text &&
					(a.text =
						n instanceof Array ? z.itemFromArray(n, e.randomIndexData) : n);
				const r = a.text,
					l = s.style,
					c = s.weight,
					d = 2 * Math.round(i),
				...
				const p = { x: -v, y: i / 2 };
				(t.globalAlpha = o),
					u ? t.fillText(r, p.x, p.y) : t.strokeText(r, p.x, p.y),
					(t.globalAlpha = 1);
			}
		}
		...
		class J {
			...
			init(t) {
				...
				return Q(this, void 0, void 0, function* () {
					...
					if (!z.isInArray(g.image, i.type) && !z.isInArray(g.images, i.type))
						return;
					const o =
						null !== (e = i.options[g.images]) && void 0 !== e
							? e
							: i.options[g.image];
				...
				return Q(this, void 0, void 0, function* () {
					try {
						const i = e.replaceColor
							? yield z.downloadSvgImage(e.src)
							: yield z.loadImage(e.src);
						i && this.addImage(t, i);
					} catch (t) {
		...
		class st {
			...
			init() {
				...
				v &&
					(u.fullScreen.enable
						? ((this.originalStyle = z.deepExtend({}, v.style)),
			...
			loadCanvas(t, e) {
				...
				t.className || (t.className = A.canvasClass),
					...
					(this.element = t),
					(this.originalStyle = z.deepExtend({}, this.element.style)),
			...
			clear() {
				...
				t.backgroundMask.enable
					...
					? this.paintBase(D.getStyleFromRgb(this.trailFillColor, 1 / e.length))
					: this.context && I.clear(this.context, this.size);
			}
			windowResize() {
			...
			drawParticleShadow(t, e) {
				this.context &&
					I.drawParticleShadow(this.container, this.context, t, e);
			}
			drawLinkTriangle(t, e, i) {
				...
				if (!v) return;
				if (
					P.getDistance(d, h) > s.retina.linksDistance ||
					P.getDistance(u, h) > s.retina.linksDistance ||
					P.getDistance(u, d) > s.retina.linksDistance
				)
					return;
			...
			drawParticle(t, e) {
				...
				const l = this.container.actualOptions,
					...
					g = D.colorToRgb(f),
					b =
						u && void 0 !== h ? h : null != g ? g : a ? D.hslToRgb(a) : void 0,
					w =
						u && void 0 !== h ? h : null != g ? g : r ? D.hslToRgb(r) : void 0,
					...
					for (const n of s) {
						...
						if (o.links.triangles.enable) {
							const r = s.map((t) => t.destination),
								l = a.links.filter(
									(t) =>
										e.particles.getLinkFrequency(a, t.destination) <=
											a.options.links.frequency && r.indexOf(t.destination) >= 0
								);
							if (l.length)
								for (const e of l) {
									const s = e.destination;
									i.getTriangleFrequency(t, a, s) >
			...
			drawPlugin(t, e) {
				this.context && I.drawPlugin(this.context, t, e);
			}
			drawLight(t) {
				this.context && I.drawLight(this.container, this.context, t);
			}
			initBackground() {
			...
			paintBase(t) {
				this.context && I.paintBase(this.context, this.size, t);
			}
			lineStyle(t, e) {
				if (!this.context) return;
				const i = this.container.actualOptions.interactivity.modes.connect;
				return I.gradient(this.context, t, e, i.links.opacity);
			}
		}
		function nt(t, e, i, o, s) {
			switch (e) {
				case m.max:
					i >= s && t.destroy();
					break;
		...
		class at {
			...
			updateLife(t) {
				...
				if (
					...
					(e.position.x = P.randomInRange(P.setRangeValue(0, t.width))),
						(e.position.y = P.randomInRange(P.setRangeValue(0, t.height))),
						(e.spawning = !0),
						(e.lifeDelayTime = 0),
						(e.lifeTime = 0),
						e.reset();
					const i = e.options.life;
					(e.lifeDelay = 1e3 * P.getValue(i.delay)),
						(e.lifeDuration = 1e3 * P.getValue(i.duration));
				}
			}
			updateOpacity(t) {
				var e, i;
				const o = this.particle,
					s = o.options.opacity,
					n = s.animation,
					a = P.getRangeMin(s.value),
					r = P.getRangeMax(s.value);
				if (
					!o.destroyed &&
					n.enable &&
					(n.count <= 0 || o.loops.size < n.count)
				) {
					switch (o.opacity.status) {
						case y.increasing:
							o.opacity.value >= r
								? ((o.opacity.status = y.decreasing), o.loops.opacity++)
								: (o.opacity.value +=
						...
						case y.decreasing:
							o.opacity.value <= a
								? ((o.opacity.status = y.increasing), o.loops.opacity++)
								: (o.opacity.value -=
										(null !== (i = o.opacity.velocity) && void 0 !== i
											? i
											: 0) * t.factor);
					}
					nt(o, n.destroy, o.opacity.value, a, r),
						o.destroyed || (o.opacity.value = P.clamp(o.opacity.value, a, r));
				}
			}
			updateSize(t) {
				var e;
				const i = this.container,
					...
					n = s.animation,
					a =
						(null !== (e = o.size.velocity) && void 0 !== e ? e : 0) * t.factor,
					r = P.getRangeMin(s.value) * i.retina.pixelRatio,
					l = P.getRangeMax(s.value) * i.retina.pixelRatio;
				if (
					!o.destroyed &&
					n.enable &&
					(n.count <= 0 || o.loops.size < n.count)
					...
					switch (o.size.status) {
						case y.increasing:
							o.size.value >= l
								? ((o.size.status = y.decreasing), o.loops.size++)
								: (o.size.value += a);
							break;
						case y.decreasing:
							o.size.value <= r
								? ((o.size.status = y.increasing), o.loops.size++)
								: (o.size.value -= a);
					}
					nt(o, n.destroy, o.size.value, r, l),
						o.destroyed || (o.size.value = P.clamp(o.size.value, r, l));
				}
			}
			updateAngle(t) {
				var e;
				...
				if (o.enable)
					switch (i.rotate.status) {
						case y.increasing:
							(i.rotate.value += s),
								i.rotate.value > n && (i.rotate.value -= n);
							break;
						case y.decreasing:
						default:
							(i.rotate.value -= s),
								i.rotate.value < 0 && (i.rotate.value += n);
					}
			}
			updateTilt(t) {
				var e;
				const i = this.particle,
					...
					s =
						(null !== (e = i.tilt.velocity) && void 0 !== e ? e : 0) * t.factor,
					n = 2 * Math.PI;
				if (o.enable)
					switch (i.tilt.status) {
						case y.increasing:
							(i.tilt.value += s), i.tilt.value > n && (i.tilt.value -= n);
							break;
						case y.decreasing:
						default:
							(i.tilt.value -= s), i.tilt.value < 0 && (i.tilt.value += n);
					}
			}
			updateRoll(t) {
				const e = this.particle,
					...
					s = 2 * Math.PI;
				i.enable && ((e.rollAngle += o), e.rollAngle > s && (e.rollAngle -= s));
			}
			updateWobble(t) {
				const e = this.particle,
					i = e.options.wobble,
			...
			updateStrokeColor(t) {
				...
				if (void 0 !== y.enable) {
					const s =
						null !==
							(i =
								null === (e = v.strokeColor) || void 0 === e ? void 0 : e.h) &&
						void 0 !== i
							? i
					...
					const o =
						null !==
							(l =
								null === (r = v.strokeColor) || void 0 === r ? void 0 : r.s) &&
						void 0 !== l
							? l
					...
					const y =
						null !==
							(h =
								null === (d = v.strokeColor) || void 0 === d ? void 0 : d.l) &&
						void 0 !== h
							? h
			...
			updateColorValue(t, e, i, o, s, n) {
				...
				const l = P.randomInRange(o.offset),
					c =
						(null !== (a = i.velocity) && void 0 !== a ? a : 0) * e.factor +
						3.6 * l;
				n && r.status !== y.increasing
					? ((r.value -= c),
					  r.value < 0 && ((r.status = y.increasing), (r.value += r.value)))
					: ((r.value += c),
					  n &&
							r.value > s &&
							((r.status = y.decreasing), (r.value -= r.value % s))),
					r.value > s && (r.value %= s);
			}
			updateOutModes(t) {
				var e, i, s, n;
			...
			updateOutMode(t, e, i) {
				...
				switch (e) {
					...
					case u.split:
						...
						break;
					case u.destroy:
						z.isPointInside(s.position, o.canvas.size, s.getRadius(), i) ||
							o.particles.remove(s, !0);
						break;
					case u.out:
						z.isPointInside(s.position, o.canvas.size, s.getRadius(), i) ||
			...
			fixOutOfCanvasPosition(t) {
				const e = this.container,
					i = this.particle,
					s = i.options.move.warp,
					n = e.canvas.size,
					a = {
						bottom: n.height + i.getRadius() - i.offset.y,
						left: -i.getRadius() - i.offset.x,
						right: n.width + i.getRadius() + i.offset.x,
						top: -i.getRadius() - i.offset.y,
					},
					r = i.getRadius(),
					l = z.calculateBounds(i.position, r);
				t === o.right && l.left > n.width - i.offset.x
					? ((i.position.x = a.left),
					  s || (i.position.y = Math.random() * n.height))
					: t === o.left &&
					  l.right < -i.offset.x &&
					  ((i.position.x = a.right),
					  s || (i.position.y = Math.random() * n.height)),
					t === o.bottom && l.top > n.height - i.offset.y
						? (s || (i.position.x = Math.random() * n.width),
						  (i.position.y = a.top))
						: t === o.top &&
						  l.bottom < -i.offset.y &&
						  (s || (i.position.x = Math.random() * n.width),
			...
			updateBounce(t, e, i) {
				...
				for (const [, i] of s.plugins)
					if (
						(void 0 !== i.particleBounce && (a = i.particleBounce(n, t, e)), a)
					)
						break;
				if (a) return;
				...
				!(function (t) {
					if (
						...
						if (
							(t.direction === o.right &&
								...
								e > 0) ||
							(t.direction === o.left && t.bounds.left <= 0 && e < 0)
						) {
							const e = P.getValue(t.particle.options.bounce.horizontal);
						...
						t.bounds.right >= t.canvasSize.width
							...
							t.outMode === u.split && t.particle.destroy();
					}
				})({
					particle: n,
					outMode: i,
					...
					(function (t) {
						if (
							...
							let i = !1;
							if (
								(t.direction === o.bottom &&
									t.bounds.bottom >= t.canvasSize.height &&
									e > 0) ||
								(t.direction === o.top && t.bounds.top <= 0 && e < 0)
							) {
								const e = P.getValue(t.particle.options.bounce.vertical);
			...
			bounceNone(t) {
				...
				if (i.enable) {
					const n = e.position;
					((i.acceleration >= 0 &&
						n.y > s.canvas.size.height &&
						t === o.bottom) ||
						(i.acceleration < 0 && n.y < 0 && t === o.top)) &&
						s.particles.remove(e);
				} else
					z.isPointInside(e.position, s.canvas.size, e.getRadius(), t) ||
						s.particles.remove(e);
			}
		}
		class rt {
		...
		class ct {
			...
			load(t) {
				void 0 !== t &&
					(void 0 !== t.color && (this.color = rt.create(this.color, t.color)),
					void 0 !== t.enable && (this.enable = t.enable),
		...
		class ut {
			constructor() {
				(this.enable = !1),
					(this.length = 10),
					(this.fillColor = new rt()),
					(this.fillColor.value = "#000000");
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.enable && (this.enable = t.enable),
					(this.fillColor = rt.create(this.fillColor, t.fillColor)),
		...
		class pt {
			constructor() {
				(this.random = new vt()), (this.value = 0);
			}
			load(t) {
				t &&
		...
		class mt {
			constructor() {
				(this.clamp = !0), (this.delay = new yt()), (this.enable = !1);
			}
			load(t) {
				void 0 !== t &&
		...
		class wt {
			...
			load(t) {
				...
				void 0 !== t.angle &&
					...
					void 0 !== t.distance && (this.distance = t.distance),
					void 0 !== t.drift && (this.drift = P.setRangeValue(t.drift)),
					void 0 !== t.enable && (this.enable = t.enable),
				...
				(void 0 === t.outModes && void 0 === s) ||
					...
					void 0 !== t.speed && (this.speed = P.setRangeValue(t.speed)),
		...
		class kt {
			constructor() {
				(this.density = new xt()), (this.limit = 0), (this.value = 100);
			}
			get max() {
				return this.limit;
			}
		...
		class Dt {
			...
			load(t) {
				void 0 !== t &&
					(void 0 !== t.count && (this.count = t.count),
					void 0 !== t.enable && (this.enable = t.enable),
					void 0 !== t.offset && (this.offset = P.setRangeValue(t.offset)),
					void 0 !== t.speed && (this.speed = t.speed),
					void 0 !== t.sync && (this.sync = t.sync));
			}
		}
		class Et {
			constructor() {
				(this.h = new Dt()), (this.s = new Dt()), (this.l = new Dt());
			}
			load(t) {
		...
		class It extends rt {
			constructor() {
				super(), (this.animation = new Et());
			}
			static create(t, e) {
				const i = null != t ? t : new It();
				return (
		...
		class Vt {
			...
			load(t) {
				void 0 !== t &&
					(void 0 !== t.color && (this.color = It.create(this.color, t.color)),
					void 0 !== t.width && (this.width = t.width),
					void 0 !== t.opacity && (this.opacity = t.opacity));
			}
		}
		...
		class Ht {
			constructor() {
				(this.horizontal = new Ft()), (this.vertical = new Ft());
			}
			load(t) {
				t &&
		...
		class Bt {
			constructor() {
				(this.lines = new _t()), (this.particles = new _t());
			}
			load(t) {
				void 0 !== t &&
		...
		class Nt {
			constructor() {
				(this.count = 0), (this.delay = new Wt()), (this.duration = new Gt());
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.count && (this.count = t.count),
		...
		class Xt {
			constructor() {
				(this.mode = l.none), (this.split = new jt());
			}
			load(t) {
				t &&
		...
		class Yt {
			...
			load(t) {
				t &&
					(void 0 !== t.distance &&
						(this.distance = P.setRangeValue(t.distance)),
					void 0 !== t.enable && (this.enable = t.enable),
					void 0 !== t.speed && (this.speed = P.setRangeValue(t.speed)));
			}
		}
		...
		class Kt {
			constructor() {
				(this.darken = new Zt()),
					(this.enable = !1),
					(this.enlighten = new Zt()),
					(this.speed = 25);
			}
			load(t) {
				t &&
					(void 0 !== t.backColor &&
						(this.backColor = rt.create(this.backColor, t.backColor)),
		...
		class te {
			...
			load(t) {
				...
				if (void 0 === t) return;
				this.bounce.load(t.bounce),
					(this.color = It.create(this.color, t.color)),
				...
				void 0 !== d &&
					(d instanceof Array
						...
						: (this.stroke instanceof Array && (this.stroke = new Vt()),
						  this.stroke.load(d)));
			}
		}
		class ee {
		...
		class ie {
			...
			moveParticle(t) {
				...
				const n = this.container,
					...
					r =
						(null !== (e = o.moveSpeed) && void 0 !== e
							? e
							: P.getRangeValue(o.options.move.speed) * n.retina.pixelRatio) *
						n.retina.reduceFactor,
					l = P.getRangeMax(o.options.size.value) * n.retina.pixelRatio,
					c = (r / 2) * (s.move.size ? o.getRadius() / l : 1) * a * t.factor,
					d =
						null !== (i = o.moveDrift) && void 0 !== i
							? i
							: P.getRangeValue(o.options.move.drift) * n.retina.pixelRatio;
				this.applyPath(t);
				const h = s.move.gravity,
					u = h.enable && h.inverse ? -1 : 1;
				h.enable &&
					(o.velocity.y += (u * (h.acceleration * t.factor)) / (60 * c)),
					c && (o.velocity.x += (d * t.factor) / (60 * c)),
					o.velocity.multTo(1 - o.options.move.decay);
				const v = o.velocity.mult(c);
				h.enable &&
					Math.abs(v.y) >= h.maxSpeed &&
					h.maxSpeed > 0 &&
					((v.y = u * h.maxSpeed), c && (o.velocity.y = v.y / c)),
					o.position.addTo(v),
					s.move.vibrate &&
				...
				o.maxDistance &&
					(y >= o.maxDistance && !o.misplaced
						...
						? (o.misplaced = !1)
						: o.misplaced &&
						  (((o.position.x < p.x && o.velocity.x < 0) ||
								(o.position.x > p.x && o.velocity.x > 0)) &&
								(o.velocity.x *= -Math.random()),
						  ((o.position.y < p.y && o.velocity.y < 0) ||
								(o.position.y > p.y && o.velocity.y > 0)) &&
			...
			applyPath(t) {
				...
				e.velocity.addTo(n),
					i.clamp &&
						((e.velocity.x = P.clamp(e.velocity.x, -1, 1)),
						(e.velocity.y = P.clamp(e.velocity.y, -1, 1))),
					(e.lastPathTime -= e.pathDelay);
			}
			moveParallax() {
				const t = this.container,
					e = t.actualOptions;
				if (z.isSsr() || !e.interactivity.events.onHover.parallax.enable)
					return;
				const i = this.particle,
				...
				const n = t.canvas.size.width / 2,
					...
					c = (s.x - n) * l,
					d = (s.y - a) * l;
				(i.offset.x += (c - i.offset.x) / r),
					(i.offset.y += (d - i.offset.y) / r);
			}
		...
		class oe {
			constructor(t, e, i, o) {
				...
				if (
					((this.shape =
						w instanceof Array ? z.itemFromArray(w, this.id, x) : w),
					null == o ? void 0 : o.shape)
				) {
					if (o.shape.type) {
						const t = o.shape.type;
						this.shape =
							t instanceof Array ? z.itemFromArray(t, this.id, x) : t;
					}
					const t = new St();
					if ((t.load(o.shape), this.shape)) {
						...
						e &&
							(this.shapeData = z.deepExtend(
								{},
								e instanceof Array ? z.itemFromArray(e, this.id, x) : e
							));
					}
				} else {
				...
				void 0 !== o && g.load(o),
					...
					(this.close =
						null !==
							...
							: this.close),
					(this.options = g),
					(this.pathDelay = 1e3 * P.getValue(this.options.move.path.delay)),
					(this.wobbleDistance = 0),
					e.retina.initParticle(this);
				const k = this.options.color,
					R = this.options.size,
					S = P.getValue(R) * e.retina.pixelRatio,
					C = "boolean" == typeof R.random ? R.random : R.random.enable;
				(this.size = { value: S }),
					(this.direction = P.getParticleDirectionAngle(
				...
				this.rotate = { value: (P.getRangeValue(A.value) * Math.PI) / 180 };
				let T = A.direction;
				if (T === n.random) {
					T =
				...
				O.enable &&
					((this.rotate.velocity = (O.speed / 360) * e.retina.reduceFactor),
					O.sync || (this.rotate.velocity *= Math.random()));
				const E = this.options.tilt;
				this.tilt = {
					value: (P.getRangeValue(E.value) * Math.PI) / 180,
				...
				const V = this.options.tilt.animation;
				V.enable &&
					((this.tilt.velocity = (V.speed / 360) * e.retina.reduceFactor),
					V.sync || (this.tilt.velocity *= Math.random()));
				const F = R.animation;
				if (F.enable) {
					if (((this.size.status = y.increasing), !C))
						switch (F.startValue) {
							case b.min:
								(this.size.value = P.getRangeMin(R.value) * m),
									(this.size.status = y.increasing);
								break;
							case b.random:
								(this.size.value = P.randomInRange(
									P.setRangeValue(F.minimumValue * m, this.size.value)
								)),
									(this.size.status =
										Math.random() >= 0.5 ? y.increasing : y.decreasing);
								break;
							case b.max:
							default:
								(this.size.value = P.getRangeMax(R.value) * m),
					...
					(this.size.velocity =
						...
						F.sync || (this.size.velocity *= Math.random());
				}
				const H = D.colorToHsl(k, this.id, x);
				if (H) {
					this.color = {
						h: { value: H.h },
						s: { value: H.s },
				...
				L.enable
					? (this.color &&
					  ...
					  (this.rollSpeed = P.getRangeValue(L.speed) / 360))
					: ((this.rollAngle = 0), (this.rollSpeed = 0));
				const q = this.options.wobble;
				q.enable
					? ((this.wobbleAngle = Math.random() * Math.PI * 2),
					  (this.wobbleSpeed = P.getRangeValue(q.speed) / 360))
					: ((this.wobbleAngle = 0), (this.wobbleSpeed = 0)),
					(this.position = this.calcPosition(this.container, i)),
					(this.initialPosition = this.position.copy()),
					(this.offset = M.create(0, 0));
				const _ = this.options.opacity,
					B = "boolean" == typeof _.random ? _.random : _.random.enable;
				this.opacity = { value: P.getValue(_) };
				const W = _.animation;
				if (W.enable) {
					if (((this.opacity.status = y.increasing), !B))
						switch (W.startValue) {
							case b.min:
								(this.opacity.value = P.getRangeMin(this.opacity.value)),
									(this.opacity.status = y.increasing);
								break;
							case b.random:
								(this.opacity.value = P.randomInRange(
									P.setRangeValue(W.minimumValue, this.opacity.value)
								)),
									(this.opacity.status =
										Math.random() >= 0.5 ? y.increasing : y.decreasing);
								break;
							case b.max:
							default:
								(this.opacity.value = P.getRangeMax(this.opacity.value)),
									(this.opacity.status = y.decreasing);
						}
					(this.opacity.velocity = (W.speed / 100) * e.retina.reduceFactor),
						W.sync || (this.opacity.velocity *= Math.random());
				}
				this.sides = 24;
				let G = e.drawers.get(this.shape);
				G ||
					((G = $.getShapeDrawer(this.shape)),
					G && e.drawers.set(this.shape, G));
				const N = null == G ? void 0 : G.getSidesCount;
				N && (this.sides = N(this));
				const U = this.loadImageShape(e, G);
				U &&
					((this.image = U.image),
					(this.fill = U.fill),
					(this.close = U.close)),
					(this.stroke =
						this.options.stroke instanceof Array
							? z.itemFromArray(this.options.stroke, this.id, x)
							: this.options.stroke),
					(this.strokeWidth = this.stroke.width * e.retina.pixelRatio);
				const j =
					null !== (v = D.colorToHsl(this.stroke.color)) && void 0 !== v
						? v
						: this.getFillColor();
				if (j) {
					this.strokeColor = {
				...
				(this.lifeDelay = e.retina.reduceFactor
					? ((P.getValue(X.delay) * (X.delay.sync ? 1 : Math.random())) /
							e.retina.reduceFactor) *
					  1e3
					: 0),
					(this.lifeDelayTime = 0),
					(this.lifeDuration = e.retina.reduceFactor
						? ((P.getValue(X.duration) *
								(X.duration.sync ? 1 : Math.random())) /
								e.retina.reduceFactor) *
						  1e3
						: 0),
					(this.lifeTime = 0),
					...
					(this.shadowColor = D.colorToRgb(this.options.shadow.color)),
					(this.updater = new at(e, this)),
					(this.infecter = new ee(e)),
					(this.mover = new ie(e, this)),
			...
			getFillColor() {
				return this.bubble.color
					...
					? this.backColor
					: D.getHslFromAnimation(this.color);
			}
			getStrokeColor() {
				var t, e;
				return null !==
					(e =
						null !== (t = this.bubble.color) && void 0 !== t
							? t
							: D.getHslFromAnimation(this.strokeColor)) && void 0 !== e
					? e
					: this.getFillColor();
			}
			destroy(t) {
			...
			split() {
				...
				const e = P.getRangeValue(t.rate.value);
				for (let t = 0; t < e; t++)
			...
			calcPosition(t, e, i = 0) {
				...
				for (const [, i] of t.plugins) {
					const t =
						void 0 !== i.particlePosition
							...
							: void 0;
					if (void 0 !== t) return M.create(t.x, t.y);
				}
				...
				return (
					(z.isInArray(r, u.bounce) || z.isInArray(r, u.bounceHorizontal)) &&
						(a.x > t.canvas.size.width - 2 * this.size.value
							? (a.x -= this.size.value)
							: a.x < 2 * this.size.value && (a.x += this.size.value)),
					(z.isInArray(r, u.bounce) || z.isInArray(r, u.bounceVertical)) &&
						(a.y > t.canvas.size.height - 2 * this.size.value
							? (a.y -= this.size.value)
							: a.y < 2 * this.size.value && (a.y += this.size.value)),
					this.checkOverlap(a, i) ? this.calcPosition(t, void 0, i + 1) : a
				);
			}
			checkOverlap(t, e = 0) {
				...
				if (!i.enable) {
					...
					for (const e of this.container.particles.array)
						if (P.getDistance(t, e.position) < this.size.value + e.size.value) {
							s = !0;
							break;
						}
					return s;
			...
			calculateVelocity() {
				...
				return (
					e.straight ||
						(t.angle += P.randomInRange(P.setRangeValue(s.left, s.right))),
			...
			loadImageShape(t, e) {
				...
				const r = e.getImages(t).images,
					l = this.shapeData,
					c =
						null !== (i = r.find((t) => t.source === l.src)) && void 0 !== i
							? i
							: r[0],
					d = this.getFillColor();
				let h;
				...
				if (void 0 !== c.svgData && l.replaceColor && d) {
					const t = D.replaceColorSvg(c, d, this.opacity.value),
						...
						n = new Image();
					(h = {
						data: Object.assign(Object.assign({}, c), { svgData: t }),
						loaded: !1,
		...
		class se {
			...
			interact() {
				...
				if (
					...
					e.interactivity.status === A.mouseMoveEvent
				) {
						...
						if (r <= s) {
							...
							if (c > 0) {
								...
								if (!e.particles.grabLineColor) {
									...
									e.particles.grabLineColor = D.getLinkRandomColor(
										i,
										t.blink,
										t.consent
									);
								}
								const s = D.getLinkColor(a, void 0, e.particles.grabLineColor);
								if (void 0 === s) return;
		...
		class ne {
			...
			isEnabled() {
				const t = this.container,
					...
					s = o.onDiv,
					n = z.isDivModeEnabled(c.repulse, s);
				if (
					!(
						n ||
			...
			interact() {
				const t = this.container,
					...
					l = o.onClick.mode,
					h = o.onDiv;
				i && s && z.isInArray(d.repulse, n)
					? this.hoverRepulse()
					: a && z.isInArray(r.repulse, l)
					? this.clickRepulse()
					: z.divModeExecute(c.repulse, h, (t, e) =>
			...
			processRepulse(t, e, i, o) {
				...
				for (const i of r) {
					const { dx: n, dy: r, distance: l } = P.getDistances(i.position, t),
						c = { x: n / l, y: r / l },
						d =
							(null !== (s = null == o ? void 0 : o.speed) && void 0 !== s
								? s
								: a.speed) * a.factor,
						h = P.clamp(P.calcEasing(1 - l / e, a.easing) * d, 0, a.maxSpeed);
		...
		function ae(t, e, i, o) {
			if (e > i) {
				const s = t + (e - i) * o;
				return P.clamp(s, t, e);
			}
			if (e < i) {
				const s = t - (i - e) * o;
				return P.clamp(s, e, t);
			}
		}
		class re {
			constructor(t) {
			...
			isEnabled() {
				const t = this.container,
					...
					o = e.interactivity.events,
					s = o.onDiv,
					n = z.isDivModeEnabled(c.bubble, s);
				if (
					!(
						n ||
						(o.onHover.enable && i.position) ||
			...
			interact() {
				const t = this.container.actualOptions.interactivity.events,
					...
					a = i.mode,
					l = t.onDiv;
				o && z.isInArray(d.bubble, s)
					? this.hoverBubble()
					: n && z.isInArray(r.bubble, a)
					? this.clickBubble()
					: z.divModeExecute(c.bubble, l, (t, e) =>
			...
			process(t, e, i, o) {
				...
				if (n !== l)
					if (s.bubble.durationEnd)
						...
						if ((null != c ? c : d) !== n) {
							const e = d - (i * (d - n)) / a;
							h === f.size && (t.bubble.radius = e),
								h === f.opacity && (t.bubble.opacity = e);
						}
					} else
						h === f.size && delete t.bubble.radius,
							h === f.opacity && delete t.bubble.opacity;
				...
				for (const o of s) {
					...
					const s = o.getPosition(),
						...
						a =
							...
							1e3;
					a > e.interactivity.modes.bubble.duration &&
					...
					const r = {
						...
						particlesObj: {
							optValue:
								P.getRangeMax(o.options.size.value) * t.retina.pixelRatio,
							value: o.size.value,
						},
						type: f.size,
					};
					this.process(o, n, a, r);
					const l = {
						bubbleObj: {
						...
						particlesObj: {
							optValue: P.getRangeMax(o.options.opacity.value),
			...
			hoverBubble() {
				...
				for (const s of o) {
					...
					n <= i
						...
						: this.reset(s),
						t.interactivity.status === A.mouseLeaveEvent && this.reset(s);
				}
			}
			hoverBubbleSize(t, e, i) {
				...
				if (void 0 === s) return;
				const n = P.getRangeMax(t.options.size.value) * o.retina.pixelRatio,
					a = ae(t.size.value, s, n, e);
			...
			hoverBubbleColor(t, e) {
				...
				if (void 0 === t.bubble.color) {
					...
					if (void 0 === s) return;
					const n = s instanceof Array ? z.itemFromArray(s) : s;
		...
		class le {
			...
			isEnabled() {
				...
				if (!i.onHover.enable || !e.position) return !1;
				const o = i.onHover.mode;
				return z.isInArray(d.connect, o);
			}
			reset() {}
			interact() {
				const t = this.container;
		...
		class ce {
			...
			interact(t) {
				...
				for (const e of d) {
					...
					let p =
						void 0 !== v.id
							? i.particles.linksColors.get(v.id)
							: i.particles.linksColor;
					if (!p) {
						const t = v.color;
						(p = D.getLinkRandomColor(t, v.blink, v.consent)),
							void 0 !== v.id
								? i.particles.linksColors.set(v.id, p)
								: (i.particles.linksColor = p);
					}
					-1 === e.links.map((t) => t.destination).indexOf(t) &&
						-1 === t.links.map((t) => t.destination).indexOf(e) &&
						t.links.push({ destination: e, opacity: u });
				}
			}
		}
		class de {
		...
		class he {
			...
			interact(t) {
				...
				for (const e of o) {
					...
					P.getDistance(i, o) <= t.getRadius() + e.getRadius() &&
			...
			resolveCollision(t, e) {
				switch (t.options.collisions.mode) {
					...
					case h.bounce:
						!(function (t, e) {
							z.circleBounce(
								z.circleBounceDataFromParticle(t),
								z.circleBounceDataFromParticle(e)
							);
						})(t, e);
						break;
					case h.destroy:
			...
			absorb(t, e) {
				...
				if (void 0 === t.getRadius() && void 0 !== e.getRadius()) t.destroy();
					...
					if (t.getRadius() >= e.getRadius()) {
						const s =
							P.clamp(t.getRadius() / e.getRadius(), 0, e.getRadius()) * o;
						(t.size.value += s),
							(e.size.value -= s),
						...
						const s =
							P.clamp(e.getRadius() / t.getRadius(), 0, t.getRadius()) * o;
						(t.size.value -= s),
							(e.size.value += s),
		...
		class ue {
			...
			interact(t, e) {
				...
				const r = a.stages[s.infectionStage],
					...
					d = t.getPosition(),
					h =
						null !== (i = r.infectedStage) && void 0 !== i
							? i
							: s.infectionStage,
			...
			isEnabled() {
				...
				return (
					(i.clicking &&
						i.inside &&
						!!i.position &&
						z.isInArray(r.trail, o.onClick.mode)) ||
					(i.inside && !!i.position && z.isInArray(d.trail, o.onHover.mode))
				);
			}
			reset() {}
		}
		class pe {
			...
			isEnabled() {
				...
				const s = o.onHover.mode,
					n = o.onClick.mode;
				return z.isInArray(d.attract, s) || z.isInArray(r.attract, n);
			}
			reset() {}
			interact() {
				const t = this.container,
					...
					a = o.onClick.enable,
					l = o.onClick.mode;
				i && s && z.isInArray(d.attract, n)
					? this.hoverAttract()
					: a && z.isInArray(r.attract, l) && this.clickAttract();
			}
			hoverAttract() {
				const t = this.container,
					e = t.interactivity.mouse.position;
			...
			processAttract(t, e, i) {
				...
				for (const i of n) {
					const { dx: o, dy: n, distance: a } = P.getDistances(i.position, t),
						r = { x: o / a, y: n / a },
						l = s.speed * s.factor,
						c = P.clamp(P.calcEasing(1 - a / e, s.easing) * l, 0, s.maxSpeed);
		...
		class fe {
			...
			isEnabled() {
				...
				return (
					(i.position &&
						o.onHover.enable &&
						z.isInArray(d.bounce, o.onHover.mode)) ||
					z.isDivModeEnabled(c.bounce, s)
				);
			}
			interact() {
				const t = this.container,
					...
					s = e.onHover.mode,
					n = e.onDiv;
				i && o && z.isInArray(d.bounce, s)
					? this.processMouseBounce()
					: z.divModeExecute(c.bounce, n, (t, e) =>
			...
			processMouseBounce() {
				...
				i && this.processBounce(i, o, new F(i.x, i.y, o + e));
			}
			...
			processBounce(t, e, i) {
				...
				for (const s of o)
					i instanceof F
						? z.circleBounce(z.circleBounceDataFromParticle(s), {
								position: t,
								radius: e,
								mass: (Math.pow(e, 2) * Math.PI) / 2,
								velocity: M.create(0, 0),
								factor: { horizontal: 0, vertical: 0 },
						  })
						: i instanceof H && z.rectBounce(s, z.calculateBounds(t, e));
			}
		}
		class ge {
			constructor(t) {
		...
		class be {
			constructor(t) {
				(this.container = t),
					...
					(this.interactionManager = new ge(t));
			...
			update(t) {
				...
				for (const e of this.array) {
					...
					o && ((e.position.x *= o.width), (e.position.y *= o.height)),
						...
						e.destroyed
							? i.push(e)
							: this.quadTree.insert(new U(e.getPosition(), e));
				}
			...
			addSplitParticle(t) {
				const e = t.options.destroy.split,
					i = new te();
				i.load(t.options);
				const o = P.getRangeValue(e.factor.value);
				i.color.load({ value: { hsl: t.getFillColor() } }),
					"number" == typeof i.size.value
						? (i.size.value /= o)
						: ((i.size.value.min /= o), (i.size.value.max /= o)),
					i.load(e.particles);
				const s = e.sizeOffset
						? P.setRangeValue(-t.size.value, t.size.value)
						: 0,
					n = {
						x: t.position.x + P.randomInRange(s),
						y: t.position.y + P.randomInRange(s),
					};
				return this.pushParticle(
					...
					(e) =>
						!(e.size.value < 0.5) &&
						((e.velocity.length = P.randomInRange(
							P.setRangeValue(t.velocity.length, e.velocity.length)
						)),
			...
			applyDensity(t) {
				var e;
				if (
					!(null === (e = t.number.density) || void 0 === e ? void 0 : e.enable)
				)
					return;
				const i = t.number,
			...
			pushParticle(t, e, i) {
				try {
					const o = new oe(this.nextId, this.container, t, e);
					let s = !0;
					if ((i && (s = i(o)), !s)) return;
		...
		class we {
			...
			init() {
				const t = this.container,
					e = t.actualOptions;
				this.pixelRatio =
					!e.detectRetina || z.isSsr() ? 1 : window.devicePixelRatio;
				const i = this.container.actualOptions.motion;
				if (i && (i.disable || i.reduce.value))
					if (z.isSsr() || "undefined" == typeof matchMedia || !matchMedia)
						this.reduceFactor = 1;
					else {
			...
			initParticle(t) {
				...
				(t.attractDistance = e.move.attract.distance * i),
					...
					(t.moveDrift = P.getRangeValue(e.move.drift) * i),
					(t.moveSpeed = P.getRangeValue(e.move.speed) * i),
					(t.sizeAnimationSpeed = e.size.animation.speed * i),
					(t.maxDistance = e.move.distance * i),
					(t.wobbleDistance = P.getRangeValue(e.wobble.distance) * i);
			}
		...
		class Re {
			constructor() {
				(this.enable = !1), (this.mode = []), (this.parallax = new Pe());
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.enable && (this.enable = t.enable),
			...
			load(t) {
				...
				void 0 !== s &&
					(s instanceof Array
						...
						: ((this.onDiv = new Me()), this.onDiv.load(s))),
					this.onHover.load(
				...
				void 0 !== t &&
					...
					void 0 !== t.color &&
						(t.color instanceof Array
							? (this.color = t.color.map((t) => rt.create(void 0, t)))
							: (this.color instanceof Array && (this.color = new rt()),
							  (this.color = rt.create(this.color, t.color)))),
					void 0 !== t.size && (this.size = t.size));
			}
		}
		...
		class Oe {
			constructor() {
				(this.distance = 80), (this.links = new Te()), (this.radius = 60);
			}
			get line_linked() {
				return this.links;
			}
		...
		class We {
			...
			load(t) {
				void 0 !== t &&
					((this.start = rt.create(this.start, t.start)),
					(this.stop = rt.create(this.stop, t.stop)));
			}
		}
		class Ge {
			constructor() {
				(this.gradient = new We()), (this.radius = 1e3);
			}
			load(t) {
				void 0 !== t &&
		...
		class $e {
			constructor() {
				(this.area = new Ge()), (this.shadow = new Ne());
			}
			load(t) {
		...
		class Ye {
			constructor() {
				(this.color = new rt()), (this.opacity = 1);
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.color && (this.color = rt.create(this.color, t.color)),
		...
		class ei {
			constructor() {
				(this.name = ""), (this.default = new ti());
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.name && (this.name = t.name),
					this.default.load(t.default),
					void 0 !== t.options && (this.options = z.deepExtend({}, t.options)));
			}
		}
		class ii {
			constructor() {
		...
		class si {
			constructor() {
				(this.disable = !1), (this.reduce = new oi());
			}
			load(t) {
				t &&
		...
		class ri {
			constructor() {
				(this.autoPlay = !0),
					(this.background = new Je()),
					(this.backgroundMask = new Qe()),
					(this.fullScreen = new ii()),
					(this.detectRetina = !0),
					(this.fpsLimit = 60),
					(this.infection = new Ke()),
					(this.interactivity = new Xe()),
					(this.manualParticles = []),
					(this.motion = new si()),
					(this.particles = new te()),
					(this.pauseOnBlur = !0),
			...
			setTheme(t) {
				if (t) {
					...
					let e = this.themes.find(
						(e) =>
							e.default.value &&
							((e.default.mode === p.dark && t) ||
								(e.default.mode === p.light && !t))
					);
					e ||
						(e = this.themes.find(
		...
		class ci {
			constructor(t, e, ...i) {
				(this.id = t),
					...
					(this.retina = new we(this)),
					(this.canvas = new st(this)),
					(this.particles = new be(this)),
					(this.drawer = new xe(this)),
					(this.pathGenerator = {
						generate: () => {
							const t = M.create(0, 0);
							return (
			...
			draw() {
				this.drawAnimationFrame = z.animate((t) => this.drawer.nextFrame(t));
			}
			getAnimationStatus() {
				return !this.paused;
			}
			...
			reset() {
				return (this._options = new ri()), this.refresh();
			}
			stop() {
				if (this.started) {
					(this.firstStart = !0),
		...
		class vi {
			...
			static set(t, e, i, o) {
				return di(this, void 0, void 0, function* () {
					const s = i instanceof Array ? z.itemFromArray(i, o) : i,
						n = vi.dom(),
					...
					if ("canvas" === e.tagName.toLowerCase()) (r = e), (l = !1);
						...
						t.length
							? ((r = t[0]),
							  r.className || (r.className = A.canvasClass),
							  (l = !1))
							: ((l = !0),
							  (r = document.createElement("canvas")),
							  (r.className = A.canvasClass),
							  (r.style.width = "100%"),
							  (r.style.height = "100%"),
							  e.appendChild(r));
					}
			...
			static loadJSON(t, e, i) {
				return di(this, void 0, void 0, function* () {
					const o = e instanceof Array ? z.itemFromArray(e, i) : e,
						s = yield fetch(o);
					if (s.ok) return vi.load(t, yield s.json());
					ui(s.status);
				});
			}
			static setJSON(t, e, i, o) {
				return di(this, void 0, void 0, function* () {
					const s = i instanceof Array ? z.itemFromArray(i, o) : i,
						n = yield fetch(s);
					if (n.ok) {
		...
		class bi {
			constructor(t, e, i, o) {
				...
				(this.absorbers = t),
					(this.container = e),
					(this.initialPosition = o ? M.create(o.x, o.y) : void 0),
					(this.options = i),
					(this.dragging = !1),
					(this.name = this.options.name),
					(this.opacity = this.options.opacity),
					(this.size = P.getValue(i.size) * e.retina.pixelRatio),
					(this.mass = this.size * i.size.density * e.retina.reduceFactor);
				const r = i.size.limit;
				this.limit =
					void 0 !== r ? r * e.retina.pixelRatio * e.retina.reduceFactor : r;
				const l = "string" == typeof i.color ? { value: i.color } : i.color;
				(this.color =
					null !== (s = D.colorToRgb(l)) && void 0 !== s
						? s
						: { b: 0, g: 0, r: 0 }),
					(this.position =
						null !==
			...
			attract(t) {
				...
				if (e.draggable) {
					...
					if (t.clicking && t.downPosition) {
						P.getDistance(this.position, t.downPosition) <= this.size &&
							(this.dragging = !0);
				...
				const i = t.getPosition(),
					{ dx: o, dy: s, distance: n } = P.getDistances(this.position, i),
					a = M.create(o, s);
				if (
					((a.length =
			...
			updateParticlePosition(t, e) {
				...
				this.options.orbits
					? (void 0 === t.orbit &&
							((t.orbit = M.create(0, 0)),
							(t.orbit.length = P.getDistance(t.getPosition(), this.position)),
					  ...
					  (t.orbit.angle +=
							((null !== (i = t.moveSpeed) && void 0 !== i
								? i
								: P.getRangeValue(t.options.move.speed) *
		...
		class ki {
			...
			init(t) {
				...
				t.absorbers &&
					(t.absorbers instanceof Array
						...
						: (this.absorbers instanceof Array && (this.absorbers = new xi()),
					...
					(o &&
						(o instanceof Array
							...
							: (this.interactivityAbsorbers instanceof Array &&
									(this.interactivityAbsorbers = new xi()),
			...
			handleClickMode(t) {
				...
				if (t === yi.absorber) {
					let t;
					o instanceof Array
						? o.length > 0 && (t = z.itemFromArray(o))
						: (t = o);
					const s = null != t ? t : i instanceof Array ? z.itemFromArray(i) : i,
			...
			loadOptions(t, e) {
				...
				if (n)
					if (n instanceof Array)
						...
						void 0 === (null == t ? void 0 : t.load) &&
							(s.interactivity.modes.absorbers = t = new xi()),
							t.load(n);
					}
			}
		})();
		...
		class Ci {
			constructor(t, e, i, o) {
				...
				null != h || (h = {}),
					...
					void 0 !== this.emitterOptions.spawnColor &&
						(this.spawnColor = D.colorToHsl(this.emitterOptions.spawnColor)),
			...
			emit() {
				...
				const e = this.container,
					...
					s = P.getRangeValue(this.emitterOptions.rate.quantity);
				for (let n = 0; n < s; n++) {
					const s = z.deepExtend({}, this.particlesOptions);
					...
					e.particles.addParticle(Si(i, o), s);
				}
			}
			setColorAnimation(t, e, i) {
				...
				const n = P.randomInRange(t.offset),
					a =
						(1e3 * P.getRangeValue(this.emitterOptions.rate.delay)) /
		...
		class zi {
			...
			load(t) {
				void 0 !== t &&
					(void 0 !== t.quantity &&
						(this.quantity = P.setRangeValue(t.quantity)),
					void 0 !== t.delay && (this.delay = P.setRangeValue(t.delay)));
			}
		}
		class Ai {
			load(t) {
		...
		class Ti {
			constructor() {
				(this.autoPlay = !0), (this.life = new Ai()), (this.rate = new zi());
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay),
					void 0 !== t.size &&
						(void 0 === this.size && (this.size = new Pi()),
						this.size.load(t.size)),
					void 0 !== t.direction && (this.direction = t.direction),
					this.life.load(t.life),
					(this.name = t.name),
					...
					void 0 !== t.position &&
						(this.position = { x: t.position.x, y: t.position.y }),
					void 0 !== t.spawnColor &&
						(void 0 === this.spawnColor && (this.spawnColor = new It()),
		...
		class Di {
			...
			init(t) {
				...
				t.emitters &&
					(t.emitters instanceof Array
						...
						: (this.emitters instanceof Array && (this.emitters = new Ti()),
					...
					(o &&
						(o instanceof Array
							...
							: (this.interactivityEmitters instanceof Array &&
									(this.interactivityEmitters = new Ti()),
			...
			handleClickMode(t) {
				...
				if (t === Oi.emitter) {
					...
					const s = null != t ? t : i instanceof Array ? z.itemFromArray(i) : i,
						n = e.interactivity.mouse.clickPosition;
					this.addEmitter(z.deepExtend({}, s), n);
				}
			}
			resize() {
				for (const t of this.array) t.resize();
			...
			addEmitter(t, e) {
				const i = new Ci(this, this.container, t, e);
				return this.array.push(i), i;
			}
			removeEmitter(t) {
				const e = this.array.indexOf(t);
			...
			loadOptions(t, e) {
				...
				if (n)
					if (n instanceof Array)
						...
						void 0 === (null == t ? void 0 : t.load) &&
							(s.interactivity.modes.emitters = t = new Ti()),
							t.load(n);
					}
			}
		})();
		...
		class Hi {
			constructor() {
				(this.color = new rt()), (this.width = 0.5), (this.opacity = 1);
			}
			load(t) {
				var e;
				void 0 !== t &&
					...
					"string" == typeof this.color.value &&
						(this.opacity =
							null !== (e = D.stringToAlpha(this.color.value)) && void 0 !== e
								? e
								: this.opacity),
					void 0 !== t.opacity && (this.opacity = t.opacity),
					void 0 !== t.width && (this.width = t.width));
		...
		class Li {
			constructor() {
				(this.enable = !1), (this.stroke = new Hi());
			}
			get lineWidth() {
			...
			set lineColor(t) {
				this.stroke.color = rt.create(this.stroke.color, t);
			}
			load(t) {
				var e;
				if (void 0 !== t) {
		...
		class qi {
			constructor() {
				(this.radius = 10), (this.type = Vi.path);
			}
			load(t) {
				void 0 !== t &&
					(void 0 !== t.radius && (this.radius = t.radius),
		...
		class _i {
			constructor() {
				this.arrangement = Ii.onePerPoint;
			}
			load(t) {
				void 0 !== t &&
			...
			load(t) {
				...
				if (void 0 !== t) {
					...
					void 0 !== i && this.inline.load(i),
						...
						void 0 !== t.position &&
							(this.position = z.deepExtend({}, t.position));
				}
			}
		}
		var Gi = function (t, e, i, o) {
			return new (i || (i = Promise))(function (s, n) {
				function a(t) {
					try {
						l(o.next(t));
		...
		function $i(t, e, i, o) {
			...
			s &&
				((t.strokeStyle = D.getStyleFromRgb(s, i.opacity)),
				(t.lineWidth = i.width),
				t.stroke(e));
		}
		function Ui(t, e, i) {
			const { dx: o, dy: s } = P.getDistances(i, t),
				{ dx: n, dy: a } = P.getDistances(e, t),
				r = (o * n + s * a) / (Math.pow(n, 2) + Math.pow(a, 2));
			let l = t.x + n * r,
				c = t.y + a * r;
			return (
				r < 0 ? ((l = t.x), (c = t.y)) : r > 1 && ((l = e.x), (c = e.y)),
				{ x: l, y: c, isOnSegment: r >= 0 && r <= 1 }
			);
		}
		function ji(t, e, i) {
			const { dx: o, dy: s } = P.getDistances(t, e),
				n = Math.atan2(s, o),
				a = Math.sin(n),
				r = -Math.cos(n),
				l = 2 * (i.x * a + i.y * r);
		...
		class Xi {
			...
			particlesInitialization() {
				...
				return (
					!(
						!t.enable ||
						t.type !== Fi.inline ||
						(t.inline.arrangement !== Ii.onePerPoint &&
							t.inline.arrangement !== Ii.perPoint)
					) && (this.drawPoints(), !0)
				);
			}
			particlePosition(t) {
				...
				if (
					...
					return z.deepExtend({}, t || this.randomPoint());
			}
			...
			draw(t) {
				...
				for (const e of this.paths) {
					...
					t &&
						(n && i && this.offset
							? $i(t, i, o.stroke, this.offset)
							: s && Ni(t, s, o.stroke));
				}
			}
			polygonBounce(t, e, i) {
				const s = this.options;
				if (!this.raw || !s.enable || i !== o.top) return !1;
				if (s.type === Fi.inside || s.type === Fi.outside) {
					let e, i, o;
					...
					for (
						...
						const l = this.raw[a],
							c = this.raw[r];
						e = Ui(l, c, s);
						const d = P.getDistances(s, e);
						if ((([i, o] = [d.dx, d.dy]), d.distance < n))
							return ji(l, c, t.velocity), !0;
					}
					if (
						e &&
						void 0 !== i &&
				...
				} else if (s.type === Fi.inline && t.initialPosition) {
					if (
						P.getDistance(t.initialPosition, t.getPosition()) >
						this.polygonMaskMoveRadius
					)
						return (
			...
			checkInsidePolygon(t) {
				...
				const o = this.container,
					s = this.options;
				if (!s.enable || s.type === Fi.none || s.type === Fi.inline) return !0;
				...
				return s.type === Fi.inside ? l : s.type === Fi.outside && !l;
			}
			parseSvgPath(t, e) {
				var i, o, s;
				const n = null != e && e;
			...
			getRandomPointByLength() {
				...
				if (
					...
					throw new Error(A.noPolygonDataLoaded);
				const s = z.itemFromArray(this.paths),
				...
				return null !==
					...
					: void 0 !==
							(null === (o = null == t ? void 0 : t.polygon) || void 0 === o
								? void 0
								: o.type) && t.polygon.type !== Fi.none;
			}
			loadOptions(t, e) {
				if (!this.needsPlugin(e)) return;
				const i = t;
				let o = i.polygon;
				void 0 === (null == o ? void 0 : o.load) && (i.polygon = o = new Wi()),
					o.load(null == e ? void 0 : e.polygon);
			}
		})();
		class Qi extends class {
			constructor() {
				pi.set(this, void 0), fi(this, pi, !1, "f");
				const t = new i(),
					e = new Y(),
					o = new J();
				$.addShapeDrawer(g.line, new Z()),
					$.addShapeDrawer(g.circle, new K()),
					$.addShapeDrawer(g.edge, t),
					$.addShapeDrawer(g.square, t),
					$.addShapeDrawer(g.triangle, new et()),
					$.addShapeDrawer(g.star, new it()),
					$.addShapeDrawer(g.polygon, new ot()),
					$.addShapeDrawer(g.char, e),
					$.addShapeDrawer(g.character, e),
					$.addShapeDrawer(g.image, o),
					$.addShapeDrawer(g.images, o);
			}
			init() {
				gi(this, pi, "f") || fi(this, pi, !0, "f");
			}
			loadFromArray(t, e, i) {
				return mi(this, void 0, void 0, function* () {
					return vi.load(t, e, i);
				});
			}
			load(t, e) {
				return mi(this, void 0, void 0, function* () {
			...
			loadJSON(t, e, i) {
				return vi.loadJSON(t, e, i);
			}
			setJSON(t, e, i, o) {
				return mi(this, void 0, void 0, function* () {
					return vi.setJSON(t, e, i, o);
				});
			}
			setOnClickHandler(t) {
			...
			constructor() {
				super(), this.addPlugin(Mi), this.addPlugin(Ei), this.addPlugin(Yi);
			}
		}
		const Ji = new Qi();
		Ji.init();
